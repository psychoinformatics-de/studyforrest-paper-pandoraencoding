...
for subj in xrange(1,20):
    ...
    subj_preprocessed_path = os.path.join('/home','mboos','SpeechEncoding','PreProcessed','subj%02dnpp%s.gzipped.hdf5' % (subj,{False:'',True:'_3T'}[T3]))
