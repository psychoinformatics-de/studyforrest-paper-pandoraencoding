...
models \todo{acronym: VWEM? used quite a bit, may be worth it} are an increasingly popular tool to characterize the relationship
...
with a button box. Catch trials were supposed to help keep the subjects’ attention to the
