...
\begin{document}
%\title{Exploring the role of auxiliary parameters in evaluating voxel-wise encoding models}
...
\affil[2]{Vicarious AI, Union City CA, USA}
...
For further details, see \citet{CTK+2012}
...
a function of the overall volume of the included voxels for 3T and 7T, for
	stability- and $r^2$-based voxel selection. Chance level is 0.5. Stars mark for which number of voxels the two curves differ significantly.}
...
$r^2$-based voxel selection. Chance level is 0.5. Stars mark for which number of voxels the two curves differ significantly.}
...
selection. Chance level is 0.04. Stars mark for which number of voxels the two curves differ significantly.
}
...
included voxels for 3T and 7T, for stability- and $r^2$-based voxel
selection. Chance level is 0.2. Stars mark for which number of voxels the two curves differ significantly.
}
...
\begin{figure*}[!htb]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.5\linewidth]{pics/conf_mats.pdf}}%
...
%NEW
In other words, the rate of true negatives is high between the instrumental and vocal genres (i.e. vocal genres do not get classified as instrumental and vice versa) and the rate of false negatives and false positives is higher in between the vocal genres than in between the instrumental genres.
...
\begin{figure}[H]
  ...
  voxel selection. Error bars denote the bootstrapped 95\% confidence interval
  of the mean. The mean is taken over binary retrieval accuracies of eight runs
  for each of the 19 participants. Chance level is 0.5. Stars mark for which number of voxels the two curves differ significantly.
}
...
\begin{figure}[H]
  ...
  19 participants. Chance level is 0.5. Stars mark for which number of voxels the two curves differ significantly.}
...
\begin{figure}[H]
  ...
  confidence interval of the mean. The mean is taken over decoding
  accuracies of eight runs for each of the 19 participants. Chance level is
    0.04. Stars mark for which number of voxels the two curves differ significantly.
}
...
\begin{figure}[H]
  ...
  $r^2$-based voxel selection. Error bars denote the bootstrapped 95\%
  confidence interval of the mean. The mean is taken over decoding
  accuracies of eight runs for each of the 19 participants. Chance level is 0.2. Stars mark for which number of voxels the two curves differ significantly.
	}
...
%NEW
So far we focused on demonstrating the effect of different analysis parameters visually.
