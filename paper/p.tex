...
\todo{Moritz please confirm that you used all subjects from both datasets.
  In that case it would be 19@3T and 20@7T -- statements of N should be
corrected based on this info (e.g. figure caption in the results}
...
\todo[inline]{what about stimulus decoding? not genre?}
...
selection.
\todo[inline]{keep color scheme for SVC: green cross; blue cross?}
...
\todo[inline]{move this section one up? feels confusion to reference the section before the last one}
...
\todo{the manuscript is unclear how exactly we do or not do this}
...
\todo{does it? Fig 6 and 7 seems to indicate the opposite}
